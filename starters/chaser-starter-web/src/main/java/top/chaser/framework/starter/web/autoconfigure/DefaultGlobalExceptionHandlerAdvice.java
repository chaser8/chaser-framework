...
public class DefaultGlobalExceptionHandlerAdvice {
    ...
    public Object errorHandler(HttpMessageNotReadableException ex) {
        log.error("", ex);
    ...
    public Object serviceException(MethodArgumentNotValidException ex) {
...
//    }
    ...
    public Object busiException(BusiException ex) {
    ...
    public Object httpMediaTypeNotSupportedException(HttpMediaTypeNotSupportedException ex){
        ...
        return R.fail(WebErrorType.MEDIA_TYPE_NOT_SUPPORTED, ex.getMessage());
    }
    @ExceptionHandler(value = {Exception.class, Throwable.class})
    public Object exception(Throwable ex) {
